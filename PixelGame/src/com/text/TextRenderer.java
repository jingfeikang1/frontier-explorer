 ...
 * 
 * @author	Chris Copeland, adapted by XGR369
 * @version	1.0
 */
...
{	
	 ...
	 */
	public static Rectangle drawString(Graphics g, String text, Rectangle bounds) {
		return drawString(g, text, bounds, TextAlignment.TOP_LEFT, TextFormat.NO_ANTI_ALIASING);
	}
	 ...
	 * @return			A <code>Rectangle</code> representing the bounds consumed by the text
	 */
	public static Rectangle drawString(Graphics g, String text, Rectangle bounds, TextAlignment align) {
		return drawString(g, text, bounds, align, TextFormat.NO_ANTI_ALIASING);
	}
	 ...
	 * @return			A <code>Rectangle</code> representing the bounds consumed by the text
	 */
	public static Rectangle drawString(Graphics g, String text, Rectangle bounds, TextAlignment align, int format)
	{
		if (g == null)
		...
		attributedString.addAttribute(TextAttribute.FOREGROUND, g.getColor());
